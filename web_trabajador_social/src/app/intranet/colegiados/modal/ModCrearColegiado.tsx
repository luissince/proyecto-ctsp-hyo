...
export default function ModCrearColegiado(props: Props) {
    ...
    return (
        <ModalCustom
            ...
            onClose={props.hide}
        >
            <form onSubmit={handleSubmit} className="relative flex flex-col min-w-0 break-words bg-white border-0 rounded-2xl shadow-xl bg-clip-border w-[650px]">
                {/* Header */}
                ...
                <div className="px-3 py-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        {/* <div className="md:col-span-2 relative">
                           <label htmlFor="Estado" className="absolute top-[-10px] left-3 bg-white text-sm text-gray-500 peer-focus:text-blue-600 px-1 transition-colors duration-200">Estado <span className="text-red-500">*</span></label>
                           <select
                                id="Estado"
                                name="Estado"
                                value={formData.es}
